...
func wireApp(bootstrap *conf.Bootstrap, confServer *conf.Server, confData *conf.Data, passport *conf.Passport, logger log.Logger) (*kratos.App, func(), error) {
	...
	grpcServer := server.NewGRPCServer(confServer, passport, logger, consoleService, userService, roleService, permissionService, passportService, menuService)
	httpServer := server.NewHTTPServer(confServer, passport, logger, userService, roleService, permissionService, passportService, menuService)

...
const file_console_administration_role_proto_rawDesc = "" +
	"\n" +
	"!console/administration/role.proto\x12\x1aapi.console.administration\x1a\x1cgoogle/api/annotations.proto\x1a\x19protobuf/pagination.proto\x1a'console/administration/permission.proto\"\xd5\x01\n" +
	...
	"pagination\x18\x01 \x01(\v2\x14.protobuf.PaginationR\n" +
	"pagination\x128\n" +
	"\x04data\x18\x02 \x03(\v2$.api.console.administration.RoleInfoR\x04data\"r\n" +
	"\x15BindPermissionRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12I\n" +
	"\x04data\x18\x02 \x03(\v25.api.console.administration.BindPermissionBodyRequestR\x04data\"\xc3\x01\n" +
	"\x19BindPermissionBodyRequest\x12#\n" +

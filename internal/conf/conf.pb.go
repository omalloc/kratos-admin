...
const file_conf_conf_proto_rawDesc = "" +
	...
	"kratos.api\x1a\x1egoogle/protobuf/duration.proto\x1a\x16protobuf/tracing.proto\x1a\x17protobuf/registry.proto\"\x98\x02\n" +
	"\tBootstrap\x12*\n" +
	"\x06server\x18\x01 \x01(\v2\x12.kratos.api.ServerR\x06server\x12$\n" +
	"\x04data\x18\x02 \x01(\v2\x10.kratos.api.DataR\x04data\x12+\n" +
	"\atracing\x18\x03 \x01(\v2\x11.protobuf.TracingR\atracing\x12.\n" +
	"\bregistry\x18\x04 \x01(\v2\x12.protobuf.RegistryR\bregistry\x12*\n" +
	"\x06logger\x18\x05 \x01(\v2\x12.kratos.api.LoggerR\x06logger\x120\n" +
	"\bpassport\x18\x06 \x01(\v2\x14.kratos.api.PassportR\bpassport\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\bPassport\x12\x16\n" +
	"\x06secret\x18\x01 \x01(\tR\x06secretB7Z5github.com/go-kratos/kratos-layout/internal/conf;confb\x06proto3"
